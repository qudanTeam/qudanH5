...
var html2canvas = function html2canvas(element, conf) {
    /* 添加自定设置高度宽度 */   
    var config = conf || {};
    var width = config.width != null ? config.width : element.ownerDocument.defaultView.innerWidth    
    var height = config.height != null ? config.height : element.ownerDocument.defaultView.innerHeight  
